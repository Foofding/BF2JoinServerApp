...
namespace BF2JoinServerApp.Data
{
    public class ProfileRepository
    {
        ...
        public void CreateProfile(string profileName)
        {
            ...
            CreateDefaultProfileFiles(newProfileFolderPath);
        ...
        private void UpdateProfileNameInConFile(string conFilePath, string newName)
        {
            ...
            for (int i = 0; i < conFileLines.Length; i++)
            {
                if (conFileLines[i].StartsWith("LocalProfile.setName"))
                {
                    ...
                    break; // We found the line, so no need to continue searching
                }
            }
        ...
        private void CreateDefaultProfileFiles(string profileFolderPath)
        {
            ...
            profileContents.AppendLine(@"LocalProfile.setName ""New Player""
                LocalProfile.setNick ""New Player""
